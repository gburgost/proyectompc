...
<body>
	<div id="mainWrapper">
		...
		<header id="titleContent"><h4>Registrar Herramienta</h4><hr></header>
		<section>
	...
	<p>
		<label for="tipo_contrato">Propiedad de la Herramienta</label>
		<select name="tipo_contrato" class="form-control" id="tipo_contrato">
			<option>Seleccione Propiedad de la Herramienta</option>
...
<div class="col-md-6">
	...
	<p>
		<label for="name">Tipo de Herramienta</label>
		<input id="name" class="form-control" name="name" type="text" />
	</p>

	<p>
		                    <label for="descobra">Descripción de la Herramienta</label>
